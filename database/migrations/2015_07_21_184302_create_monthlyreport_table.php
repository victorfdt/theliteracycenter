    ...
    public function up()
    {
       //Create the table
        Schema::create('monthly_reports', function (Blueprint $table) {
            ...
            $table->double('total_prep_time', 5, 2)->nullabble();
            $table->double('total_travel_time', 5, 2)->nullabble();
            $table->double('total_mileage', 5, 2)->nullabble();
            $table->text('goals_progress')->nullabble();
